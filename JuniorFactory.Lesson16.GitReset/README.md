# 16. Git Reset и Revert

## Краткое описание

Короткое дополнение к уроку про Git: как откатывать изменения – reset, revert и разница между ними.

## Видео

Таймкоды с описанием можно посмотреть [здесь](video.md) (авто-расшифровка, возможны неточности)

Небольшое продолжение [урока 3](../JuniorFactory.Lesson03.Git): откат коммитов через reset и revert.
